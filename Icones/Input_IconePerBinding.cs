...
public class Input_IconePerBinding : Input_Icone
{
    ...
    void OnEnable() 
    {
        ...
        MostrarIcone(inputBinding.action, overrided);
    }
    

    
    public void MostrarIcone() => MostrarIcone(inputBinding.action, overrided);
    public void MostrarIcone(InputActionReference inputActionReference) => MostrarIcone(inputActionReference.action, overrided);
