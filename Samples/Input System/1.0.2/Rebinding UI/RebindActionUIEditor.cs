...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_GuardarEventProperty = serializedObject.FindProperty("m_guardatEvent");
            m_infoMessageProperty = serializedObject.FindProperty("m_infoMessage");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_GuardarEventProperty);
                EditorGUILayout.PropertyField(m_infoMessageProperty);
        ...
        private SerializedProperty m_infoMessageProperty;
